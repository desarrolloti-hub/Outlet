...
export class Category {
    constructor(data = {}) {
        ...
        // 🖼️ IMAGEN EN FIREBASE STORAGE
        this.imageUrl = data.imageUrl || '';          // URL de Firebase Storage
        this.imageStoragePath = data.imageStoragePath || ''; // Ruta en Storage
    ...
    get hasImageInStorage() {
        return !!this.imageStoragePath && this.imageStoragePath.trim() !== '';
    }
